...
num = input("Please enter a value for x: ")
x = int(num)
y = x**2
z = x**3
...
diff = my_age - age
if diff==0:
	print(f"Hey, we're both the same age!")
elif diff > 0:
	print(f"You are {age} years old and I am {my_age} years old, I am {diff} years older than you!")
else:
	print(f"You are {age} years old and I am {my_age} years old, I am {-diff} years younger than you!")
...
# Testing line here to validate git branch second creates a secondary branch, this line should appear in the master 
# branch on git
